    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="w-[200px] p-0">
                <Command>
                    <CommandList>
                        {/* <CommandList items={formattedItems} onSelect={onStoreSelect} selectedItem={currentStore}> */}
                        <CommandInput placeholder="Search for a store"></CommandInput>
                    ...
                    <CommandList>
                        <CommandGroup>
                            <CommandItem onSelect={() => { setOpen(false); storeModal.onOpen() }} className="text-sm">
